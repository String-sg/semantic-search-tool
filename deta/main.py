...
url_4 = "https://kwen1510.github.io/whereDoYouMean/videos_segments_embeddings_1.json"
url_5 = "https://kwen1510.github.io/whereDoYouMean/videos_segments_embeddings_2.json"
...
videos_segments_embeddings_1 = load_json_file(url_4)
videos_segments_embeddings_2 = load_json_file(url_5)
...
'''
Steps
1) Upload JSON files to github (need to clone then push cos large file sizes)
2) load using urlopen and json.loads
3) PUsh env variables in
4) deta new
5) deta deploy
'''